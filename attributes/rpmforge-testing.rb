...
default['yum']['rpmforge-testing']['mirrorlist'] = (platform?('amazon') ? 'http://mirrorlist.repoforge.org/el6/mirrors-rpmforge-testing' : "http://mirrorlist.repoforge.org/el#{node['platform_version'].to_i}/mirrors-rpmforge-testing")
