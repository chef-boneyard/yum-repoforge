...
default['yum']['rpmforge']['mirrorlist'] = (platform?('amazon') ? 'http://mirrorlist.repoforge.org/el6/mirrors-rpmforge' : "http://mirrorlist.repoforge.org/el#{node['platform_version'].to_i}/mirrors-rpmforge")
